...
parser.add_argument(
    "--title", help="Title for the YAML header", default="Default Title"
)
parser.add_argument(
    "--summary", help="summary for the YAML header", default="Default Summary"
)
parser.add_argument("--author", help="Author for the YAML header", default="Bill")
parser.add_argument(
    "--header-img",
    help="image for the YAML header",
    default="img/bill/header-posts/2024-01-24-header.png",
)
...
parser.add_argument(
    "--stickie", action="store_true", help="set this blog to the top", default=False
)
parser.add_argument(
    "--hide", action="store_true", help="hide this blog?", default=False
)
parser.add_argument(
    "--life", action="store_true", help="this blog is for life not tech?", default=False
)
parser.add_argument(
    "--guitartab",
    action="store_true",
    help="this blog is for guitartab?",
    default=False,
)
parser.add_argument(
    "--tags", help="Comma-separated tags for the YAML header", default=""
)
